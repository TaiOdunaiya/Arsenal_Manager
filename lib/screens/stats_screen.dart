      ...
      builder: (context, provider, _) {
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              // Donut chart — square box so the pie is not clipped when width > fixed height
              LayoutBuilder(
              ...
              const SizedBox(height: 12),
              ...provider.divisions.map((division) {
                final items = provider.gear
                ...
                return Padding(
                  ...
                  child: CardTextureBackground(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(division.name,
                            style: const TextStyle(color: AppTheme.wayneBlue)),
                        Text(
